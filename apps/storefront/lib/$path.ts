  ...
  _channel: (channel: string | number) => ({
    _locale: (locale: string | number) => ({
      ...
      account: {
        addressBook: {
          $url: (url?: { hash?: string }) => ({
            pathname: "/[channel]/[locale]/account/addressBook" as const,
        ...
        login: {
          $url: (url?: { query?: OptionalQuery0; hash?: string }) => ({
            pathname: "/[channel]/[locale]/account/login" as const,
        ...
        orders: {
          $url: (url?: { hash?: string }) => ({
            pathname: "/[channel]/[locale]/account/orders" as const,
            query: { channel, locale },
            hash: url?.hash,
          }),
        ...
        preferences: {
          $url: (url?: { hash?: string }) => ({
            pathname: "/[channel]/[locale]/account/preferences" as const,
            query: { channel, locale },
            hash: url?.hash,
          }),
        },
        register: {
          $url: (url?: { hash?: string }) => ({
            pathname: "/[channel]/[locale]/account/register" as const,
            query: { channel, locale },
            hash: url?.hash,
          }),
        },
      ...
      checkout: {
        $url: (url?: { hash?: string }) => ({
          pathname: "/[channel]/[locale]/checkout" as const,
          query: { channel, locale },
          hash: url?.hash,
        }),
      },
      collection: {
        _slug: (slug: string | number) => ({
          $url: (url?: { hash?: string }) => ({
            pathname: "/[channel]/[locale]/collection/[slug]" as const,
            query: { channel, locale, slug },
            hash: url?.hash,
          }),
        }),
